...
# в этой строке вызываем библиотеку os, затем вызываем модуль path и в join передаем два аргумента, первый BASE_DIR,
# второй название подключаемой папки templates
...
# 5. Прописываем url - всегда одна на весь проект(но у каждого приложения может быть своя url которую мы прописываем в
# основную url проекта
