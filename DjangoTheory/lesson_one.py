...
# 4. settings - отвечает за настроки в всем проэкте, (подкючение бд, приложения, time zone, static file)
#     INSTALLED_APPS - связываем разные приложения одного проекта
# 5. urls - с помощью этого файла мы строим пути к нашим url приложений проекта
#    импорт view из приложений проекта
