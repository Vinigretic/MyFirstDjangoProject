...
# 4. settings - отвечает за настроки во всем проэкте, (подкючение бд, приложения, time zone, static file)
# в INSTALLED_APPS - связываем разные приложения одного проекта
# 5. urls - с помощью этого файла мы строим пути к нашим url приложений проекта, обязательно в urls необходимо
#    импортировать   view из приложений проекта
#    в первой строке списка urlpatterns  с помощью функции path создаем URL, затем создаем пустую строку,
#    означает описываем главную страницу
#    вторым параметром  передаем view.index(index - название функции в view) - обращение к поведению нашей url
