...
# При создании запроса на создание данных(информация заполняется на клиенте и передается на сервер) всегда используем
# метод POST - <form method="POST">, при работе с django template методы описываем  в HTML
